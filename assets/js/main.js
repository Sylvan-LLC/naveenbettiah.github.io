        ...
        googleMap: function() {
            if ( $().gmap3 ) {
                var contentString = '<div id="content">'+
                    ...
                    '<h3>MOXY GLOBAL FZE</h3>'+
                    '<p>P.O. Box - 50357, Hamriyah Free Zone, Sharjah, UAE<br />Tel. : +9716 5755195,<br />E-mail : moxyglobal@gmail.com' +
                    '</p>'+
                    '</div>';
                $('#gmap')
                .gmap3({
                    center: [25.4555903, 55.5014269],
                    zoom: 14,
                    scrollwheel: false
                })
                .infowindow({
                    position: [25.4555903, 55.5014269],
